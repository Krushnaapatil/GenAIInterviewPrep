...
const Home = () => {
    ...
    const handleFileChange = (e) => {
        ...
        if (file) {
            ...
            if (!fileValidation.isValid) {
                warningToast(fileValidation.error)
                e.target.value = ''
                return
            }
    ...
    const handleGenerateReport = async () => {
        // Check rate limiting
        const rateCheck = rateLimiter.isAllowed('generateReport')
        ...
        const validationResult = validateInterviewInputs({
            jobDescription,
            selfDescription,
        ...
        try {
            ...
            const sanitizedJobDescription = sanitizeMultilineText(jobDescription, { maxLength: 5000 });
            const sanitizedSelfDescription = sanitizeMultilineText(selfDescription, { maxLength: 2000 });
                        ...
                        <div className='upload-section'>
                            ...
                            {uploadedFile ? (
                                <div className='dropzone dropzone--uploaded'>
                                    ...
                                    <p className='dropzone__title'>{uploadedFile.name}</p>
                                    <p className='dropzone__subtitle'>PDF uploaded successfully</p>
                                    <button type='button' onClick={() => { setUploadedFile(null); resumeInputRef.current.value = ''; }} className='dropzone__clear'>Clear</button>
                                </div>
                            ) : (
